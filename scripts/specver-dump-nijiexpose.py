...
f = open("build_out/session-describe")
...
print("%define inochi_session_ver", GITVER)
print("%define inochi_session_semver", SEMVER)
print("%define inochi_session_dist", GITDIST)
print("%define inochi_session_commit", COMMIT)
print("%define inochi_session_short", COMMIT[:7])
print()
...
deps = list(find_deps("inochi-session", dep_graph))
deps.sort()
